...
- (void)getCollectionItems:(NSString *)collectionPID {   //TODO: FIX collection public/private restrictions!!!
...
- (void)getLibraries {
    ...
    NSString *defaultURL = @"https://registr.digitalniknihovna.cz/libraries.json?ios=2";
