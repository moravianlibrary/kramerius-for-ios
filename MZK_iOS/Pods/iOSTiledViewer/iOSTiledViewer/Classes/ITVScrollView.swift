...
extension ITVScrollView: UIGestureRecognizerDelegate {
    ...
    public func gestureRecognizer(_ gestureRecognizer: UIGestureRecognizer, shouldRecognizeSimultaneouslyWith otherGestureRecognizer: UIGestureRecognizer) -> Bool {
        let myGestures: Set<UIGestureRecognizer> = [singleTapRecognizer, doubleTapRecognizer]
        let eventGestures: Set<UIGestureRecognizer> = [gestureRecognizer, otherGestureRecognizer]
